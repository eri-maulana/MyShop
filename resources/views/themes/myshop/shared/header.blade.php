<nav class="navbar navbar-expand-lg bg-light fixed-top py-4 shadow-sm">
   <div class="container">
     <a class="navbar-brand" href="#">My<span>Shop</span></a>
       ...
       <div class="collapse navbar-collapse" id="navbarNav">
         <div class="input-group mx-auto mt-5 mt-lg-0">
           ...
           <button class="btn btn-outline-success" type="button" id="button-addon2"><i class="bx bx-search" ></i></button>
         </div>
         <ul class="navbar-nav ms-auto mt-3 mt-sm-0">
           <li class="nav-item me-3">
             <a class="nav-link active" href="#">
               <i class="bx bx-heart" ></i>
               <span class="badge text-bg-success rounded-circle position-absolute">2</span>
             </a>
           </li>
           <li class="nav-item me-5">
             <a class="nav-link" href="#">
               <i class="bx bx-cart-alt"></i>
               <span class="badge text-bg-success rounded-circle position-absolute">3</span>
             </a>
           </li>
           <!-- mobile menu -->
           ...
           <li class="nav-item mt-4 mt-lg-0 text-center">
             <a class="nav-link btn-sm btn-second me-lg-3" href="#">Login</a>
           </li>
           <li class="nav-item mt-1 mt-lg-0 text-center">
